...
This project uses glassmorphism effects. Follow these patterns:
...
### Custom Glassmorphism Classes (from tailwind.config.ts)
...
- `animate-glass-shimmer` - Glassmorphism shimmer
